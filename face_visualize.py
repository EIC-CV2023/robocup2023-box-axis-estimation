...
def draw_points(frame, keypoints, color=(0, 0, 255), conf=0.7):
...
model = YOLO("weights/pretest-vertices-pose.pt", task="pose")
...
while cap.isOpened():
    ...
    for obj_kpts, obj_box in zip(kpts, boxes):
        ...
        draw_points(frame, obj_kpts, color=(255,255,255))

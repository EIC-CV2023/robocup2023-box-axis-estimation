...
def dof(frame, vector_dir, max_len=75, color=(255, 0, 0), center="default"):
    x, y, z = vector_dir
    if center == "default":
...
while cap.isOpened():
    ...
    for obj_kpts, obj_box in zip(kpts, boxes):
        ...
        keras_input = process_kpts_with_label(obj_kpts, 1)
